...
class MyDrawer extends React.Component {
  ...
  render() {
    const { getFieldDecorator } = this.props.form;
        return (this.state.loading ? <div style={{ display: 'flex', justifyContent: 'center', paddingTop: 36 }}> <Spin size='large' /></div> :
                <div>
                ...
                <Drawer
                    ...
                    <Tabs activeKey={this.state.activeTab} onChange={this.changeTab}>
                        <TabPane tab="Mapping Import" key="1">
                            <div onClick={() => this.changeTab("2")} style={{ paddingBottom: 12 }}>
