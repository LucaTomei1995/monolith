        ...
        <Layout>
          <Content>
            ...
            >
              ...
              <Route
                exact
                path="/open/ontology/wiki/:predicateType?/:entityID?"
                render={props =>
              ...
              <Route
                exact
                path={"/open/ontology/wiki/" + predicateTypes.c + "/:entityID"}
                render={props => (
              ...
              <Route
                exact
                path={"/open/ontology/wiki/" + predicateTypes.op + "/:entityID"}
                render={props => (
                  <ObjectPropertyPage
                    {...props}
                    ontology={this.props.ontology}
              ...
              <Route
                exact
                path={"/open/ontology/wiki/" + predicateTypes.dp + "/:entityID"}
                render={props => (
              ...
              <Route
                exact
                path={"/open/ontology/wiki/" + predicateTypes.i + "/:entityID"}
                render={props => (
