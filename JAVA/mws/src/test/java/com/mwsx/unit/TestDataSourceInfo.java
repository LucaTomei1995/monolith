...
public class TestDataSourceInfo {
	...
	public static void main(String[] args) throws IOException, InterruptedException, OWLOntologyCreationException, OWLOntologyStorageException, MappingFileMalformedException, SAXException {
		...
		MappingInfo mi2 = manager.getMappingInfo("UNIT1", "http://www.obdasystems.com/unit1/1.0", "UNIT1_02");
		MappingInfo mi3 = manager.getMappingInfo("UNIT1", "http://www.obdasystems.com/unit1/1.0", "UNIT1_03");
		
		ObjectMapper om = new ObjectMapper();
		om.enable(SerializationFeature.INDENT_OUTPUT);
		System.out.println(om.writeValueAsString(mi2));
		System.out.println(om.writeValueAsString(mi3));
