...
public class TestKGInstancePage {
	...
	public static void main(String[] args) throws IOException, InterruptedException, OWLOntologyCreationException, OWLOntologyStorageException, MappingFileMalformedException, SAXException {
		...
		kgf.setFile(Utils.getFileInfo("./src/test/resources/triples/Regione_18.ntriples", "Regione_18.ntriples", "N3"));
		...
		InstancePage ip = manager.getInstancePage(session, kg, "http://lod.aci.it/ontology/Regione/18", null);
