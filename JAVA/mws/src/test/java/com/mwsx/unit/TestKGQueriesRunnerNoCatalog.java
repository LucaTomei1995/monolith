...
public class TestKGQueriesRunnerNoCatalog {
...
//				"SELECT $X $Y $Z WHERE {$X $Y $Z}");
		...
		manager.startKGQuery(session, kg, "http://kg/iris/com/ui/q1", q1);
//		manager.startKGQuery(session, kg, "http://kg/iris/com/ui/q1", q2);
		...
		res = manager.getKGQueryResult(session, kg, "Q1", 5, 0);
		System.out.println(om.writeValueAsString(res));
