...
public class Help2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<MethodInfo> infos = MwsxAvailabilityTools.getProvidedMethodsList(MwsxKGService.class);
		int doneCount = 0;
		int toDoCount = 0;
		int donePerc = 0;
		int toDoPerc = 0;
	...
	private String l(String innerReturnType) {
		...
		ret = ret.replace("[L]", "./HelpTypeKG?" + innerReturnType);
